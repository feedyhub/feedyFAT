  ...
  public class XpsConverter
  {
    ...
    public static void Convert(string xpsFilename, string pdfFilename, int docInde)
    {
      Convert(xpsFilename, pdfFilename, docInde, false);
        ...
        public static void Convert(XpsDocument xpsDocument, string pdfFilename, int docIndex, bool createComparisonDocument)
        {
            if (xpsDocument == null)
                throw new ArgumentNullException("xpsFilename");
            ...
            try
            {
                ...
                {
                    System.Windows.Xps.Packaging.XpsDocument xpsDoc = new System.Windows.Xps.Packaging.XpsDocument("comparison", FileAccess.Read);
